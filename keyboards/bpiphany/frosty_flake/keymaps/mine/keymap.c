...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(\
    ...
    TD(TD_CTCPS), KC_LGUI, KC_LALT,       KC_SPC,        KC_LEAD, KC_RGUI, KC_APP, MO(2),  KC_LEFT, KC_DOWN, KC_RGHT, KC_P0,   KC_PDOT   \
  ),
  [1] = LAYOUT(\
    ...
    KC_RCTRL, KC_MPRV, KC_MPLY, KC_MNXT, LCTL(KC_R), KC_T, KC_CALC, KC_PGUP, KC_HOME, KC_PGDN, KC_P, KC_LBRC, KC_RBRC, KC_BSLS, KC_MS_BTN1, KC_MS_BTN2, KC_TRNS, KC_A, KC_A, KC_A, KC_A, \
