...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(\
    ...
    KC_RCTRL, KC_MPRV, KC_MPLY, KC_MNXT, LCTL(KC_R), KC_T, KC_CALC, KC_PGUP, KC_HOME, KC_PGDN, KC_P, KC_LBRC, KC_RBRC, KC_BSLS, KC_MS_BTN1, KC_MS_BTN2, KC_TRNS, KC_A, KC_A, KC_A, KC_A, KC_A, \
    KC_TRNS, KC_VOLD, KC_VOLU, KC_MUTE, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  \
    MO(2), KC_MENU, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_END, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_UP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, \
