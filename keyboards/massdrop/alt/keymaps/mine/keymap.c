...
uint8_t led_default_rotate_pattern[8] = {  //each instruction group in led_instruction_list has a default rotate pattern (number is position in led_setups array defined in led_programs.c)
    4,
    4,
    4,
    0,
