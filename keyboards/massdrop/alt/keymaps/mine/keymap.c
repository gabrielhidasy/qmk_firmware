...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   _______, _______, _______, _______, KC_HOME, U_T_AGCR, KC_PSCR, KC_SLCK, KC_PAUS, KC_LEAD, KC_END, \
        L_T_PTD, L_PTP,   L_BRD,   L_PTN,   _______, _______, KC_LEFT, KC_DOWN, KC_UP   ,KC_RGHT, KC_INS , _______,          _______, KC_VOLU, \
        L_T_MD, KC_APP,  L_T_ONF, _______, _______, MD_BOOT, KC_END, TG_NKRO, _______, _______, _______, _______,          KC_PGUP, KC_VOLD, \
